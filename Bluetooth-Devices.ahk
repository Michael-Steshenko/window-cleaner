; This is a V1 AutoHotkey script, I moved to V2 and I'm not sure this is needed or if this even works on newer versions of Windows
; keeping this in case I want to udpate it in the future.
